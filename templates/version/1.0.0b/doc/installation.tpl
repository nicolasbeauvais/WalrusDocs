...
<ul>
    <li>Templating : Template Engine you want to use, we support Smarty, Haml and native PHP.</li>
    <li>Environment : In which environment you want to make your project at this time.</li>
</ul>
