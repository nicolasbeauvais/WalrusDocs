<div id="changelog">
    ...
    {* WalrusFrontHelpers *}
    <h6><span class="new">New</span> WalrusFrontHelpers</h6>

    <p>Register all Helpers and dispatch them with the WalrusFrontController to the front-end script. Helpers can be
       add or extended with a simple method</p>
